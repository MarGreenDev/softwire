...
<div class="bg-pink-100/70 backdrop-blur-sm col-span-12 flex-1">
    ...
    <div class="flex flex-col p-5 items-center text-pink-600">
        ...
        <article class="flex flex-col gap-5">
            ...
            <div class="w-xl p-4 flex flex-col gap-3">
            ...
            <section>
                ...
                <h3 class="font-semibold text-3xl text-pink-800">Currently working on</h3>
